...
import dev.aventix.station.resource.server.station.expire.category.request.StationExpireProductCategoryDeleteRequest
import dev.aventix.station.resource.server.station.expire.category.request.StationExpireProductCategoryPatchRequest
...
class StationExpireProductCategoryService(
    ...
    fun create(createRequest: StationExpireProductCategoryCreateRequest): StationExpireProductCategoryDTO {
        return this.stationExpireItemCategoryRepository.saveAndFlush(StationExpireProductCategoryEntity().apply {
